  ...
  return (
    <div className='bg-white h-16 lg:h-24'>
      <div className='flex justify-between items-center container mx-auto h-full'>
        ...
        <nav className={`lg:flex lg:items-center ${showMenu ? 'absolute top-16 z-50  bg-white h-full w-full  left-0 right-0 grid place-content-center' : 'hidden'} lg:block`}>
        ...
        <div className='flex items-center gap-5'>
          <button className='flex items-center text-gray-600 text-lg hover:text-red-500 focus:outline-none'>
            ...
            <span className='ml-2 text-sm'>Kullanıcı Girişi</span>
          </button>
